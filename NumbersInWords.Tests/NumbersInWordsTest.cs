...
public class NumbersInWordsTest
{
    ...
    [InlineData(13_514_015,
        "tretten millioner fem hundre og fjorten tusen og femten"
    )]
    [InlineData(2_010_812, "to millioner ti tusen åtte hundre og tolv")]
    [InlineData(16_017_018_019,
        "seksten milliarder sytten millioner atten tusen og nitten"
    )]
    ...
    [InlineData(987_654_321,
        "ni hundre og åttisyv millioner seks hundre og femtifire tusen tre hundre og tjueen"
    )]
